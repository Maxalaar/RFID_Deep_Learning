...
def recurrent_neural_network_classifier(data_x, data_y, verbose=[]):
    ...
    history = model.fit(data_x, data_y, epochs=int(800), batch_size=batch_size, validation_split=0.8, shuffle=True, verbose=1, callbacks=[es]) # , callbacks=[es]